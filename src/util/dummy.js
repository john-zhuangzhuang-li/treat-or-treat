...
export const DUMMY_URL = process.env.PUBLIC_URL;

export const DUMMY_USER_ADDRESSES = [
  {
    id: "demo-address-1",
...
export const DUMMY_USER_CONTACTS = [
  {
...
export const DUMMY_SORTING_OPTIONS = [
...
export const DUMMY_COLLECTION_LOGOS = {
...
// for (const collection in DUMMY_PRODUCT_DATA) {
//   const { id, title, url, imageLandscapeLarge, imageLandscapeMedium } =
//     DUMMY_PRODUCT_DATA[collection];
//   const newItem = {};
//   newItem[collection] = {
//     id,
//     title,
//     url,
//     imageLandscapeLarge,
//     imageLandscapeMedium,
//   };
//   collectionList = { ...collectionList, ...newItem };
// }
